...
/** Calculate time remaining until the end of the current month */
function getTimeUntilEndOfMonth(): string {
  const now = new Date();
  ...
  const renderLeagueHeader = () => (
    <View style={styles.leagueContainer}>
      ...
      <View style={styles.leagueInfoRow}>
        ...
        <Text style={styles.timerText}>{getTimeUntilEndOfMonth()}</Text>
      </View>
    </View>
  );
